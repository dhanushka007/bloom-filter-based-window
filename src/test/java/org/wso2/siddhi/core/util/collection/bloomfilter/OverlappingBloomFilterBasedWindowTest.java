...
public class OverlappingBloomFilterBasedWindowTest {

	private OverlappingBloomFilterBasedWindow window;
	private int count;
	int windowSize;
	...
	public void setUp() {
		...
		windowSize = 10;
		Expression[] expressions = { new IntConstant(windowSize), new IntConstant(1), new IntConstant(0) };
		count = 0;
